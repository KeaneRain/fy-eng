...
export function Contact() {
  ...
  return (
    <section id="contact" ref={ref}>
      <div className="bg-navy-950/40 border-t border-navy-800 py-16 px-12 md:px-16">
      ...
      <footer className="bg-navy-950/40 border-t border-navy-800 py-5 px-12 md:px-16">
